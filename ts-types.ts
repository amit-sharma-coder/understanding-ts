...
// Literal Type
// -----------------
// This is where we define the type of a variable as a literanl and not any datatype
let conversionType: 'as-number' | 'as-text';


// Type Aliases or Custom Type
// ------------------------------
type newType = number | string;
function typeCombineFunc(input1: newType, input2: newType) {}